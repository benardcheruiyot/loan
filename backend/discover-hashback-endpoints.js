...
const API_KEY = String(process.env.HASHPAY_API_KEY || '').trim();
const API_SECRET = String(process.env.HASHPAY_API_SECRET || '').trim();
const BASE_URL = 'https://api.hashback.co.ke';

if (!API_KEY || !API_SECRET) {
  throw new Error('HASHPAY_API_KEY and HASHPAY_API_SECRET are required.');
}
